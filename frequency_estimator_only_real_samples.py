...
df.to_excel("tables\\zero_crossings_auto_generated_table_real_samples_only.xlsx", index=False)
print("Table saved as 'zero_crossings_auto_generated_table_real_samples_only.xlsx'")
